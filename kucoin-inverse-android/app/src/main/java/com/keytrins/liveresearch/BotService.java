...
public class BotService extends Service {
    private static final String CHANNEL = "kucoin_inverse_bot";
    ...
    @Override public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        BotRuntime.status = s.live ? "KUCOIN INVERSE LIVE • запуск" : "KUCOIN INVERSE OBSERVE • запуск";
    ...
    private void createChannel() {
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationChannel c = new NotificationChannel(CHANNEL, "KuCoin Inverse", NotificationManager.IMPORTANCE_LOW);
            c.setDescription("Фоновый мониторинг KuCoin Futures и управление позициями");
    ...
    private Notification notification(String text) {
        ...
        return b.setContentTitle("KuCoin Inverse")
                .setContentText(text)
